...
<section class="container">
	<div class="w3-row-padding">
		...
		<h1 class="large text-primary">
			Assets <b><span class="w3-small w3-text-teal w3-wide">(Others : <span class="w3-text-dark-grey">Power Switch, Frame & Back Cover</span>)</span></b>
		</h1>
		</div>
...
$sql = "SELECT * FROM assets WHERE category = 'Others' ORDER BY id DESC";
