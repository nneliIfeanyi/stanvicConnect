...
<body>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex mx-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="index.php#assets"> Assets</a>
                </li>
                <li class="nav-item">
          ...
          <div class="carousel-item active">
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="images/pexels3.jpg" alt="" style="border-radius: 50%;">
                  </div>
                </div>
              </div>
            </div>
          ...
          <!--<div class="carousel-item">
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="images/pexels2.jpg" alt="" style="border-radius: 50%;">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="carousel-item">
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="images/pexels1.jpg" alt="" style="border-radius: 50%;">
                  </div>
                </div>
              </div>
            </div>
  ...
  <section class="about_section ">
    <div class="container">
      <div class="row">
        <!--<div class="col-md-6">
          <div class="img-box">
            <img src="images/pexels2.jpg" width="60%" height="230px" alt="">
          </div>
        </div>-->
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
             Instead of searching from pillar to post, moving round and round  for Assets: this platform solves the problem, log in to your account to view already uploaded Assets by fellow engineers and upload yours aswell.
            </p>
  ...
  <!-- service section -->
  <section class="service_section layout_padding" id="assets">
    <div class="container-fluid">
      <div class="heading_container">
        <h2>
          Assets
      ...
      <div class="service_container">
        <div class="box mySlides">
          <div class="img-box">
            <img src="images/d_board.jpg" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Down Boards
        ...
        <div class="box mySlides">
          <div class="img-box">
            <img src="images/sim_tray.jpg" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Sim Tray
        ...
        <div class="box mySlides">
          <div class="img-box">
            <img src="images/pexels3.jpg" alt="">
          </div>
          <div class="detail-box">
            <h5>
              Others
    ...
    <section class="contact_section layout_padding" id="contactLink">
      <div class="container">
        <div class="heading_container">
          ...
          <p>This is a work in progress tell us how we can improve, your opinion does matter.</p>
        </div>
      </div>
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="info_links">
              ...
              <ul class="  ">
                ...
                <li class="">
                  <a class="" href="assets.php">Fellows</a>
                </li>
                <li class="">
                  <a class="" href="fellows.php"> Services </a>
                </li>
                <li class="">
                  <a class="" href="#contactLink">S.Box</a>
                </li>
              </ul>
            </div>
          </div>-->
