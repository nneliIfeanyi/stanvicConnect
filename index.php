...
<html lang="en">
	<head>
		...
		<meta name="keyword" content="" />
			...
			<title>Welcome | stanvicConnect</title>
	</head>
	<body class="w3-serif">
		<?php
		...
		<section class="landing" style="background: url(images/pexels3.jpg) no-repeat center center/cover;">
			<div class="dark-overlay">
				<div class="inner-landing">
					<h1 class="w3-cursive w3-medium w3-padding-16">Phone Repairs Connect</h1>
					<p class="lead w3-serif x-large">Murada is Online</p>
